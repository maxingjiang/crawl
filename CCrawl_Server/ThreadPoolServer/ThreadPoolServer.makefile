...
${BIN_TARGET}:${OBJ}
	$(CC) -shared $(OBJ) -o $@ $(LIB)
	mkdir -p ${DIR_BIN}/include/ThreadPoolServer/
	cp -r ${DIR_INC}/* ${DIR_BIN}/include/ThreadPoolServer/
...
clean:
	...
	rm -rf ${DIR_BIN}/include/ThreadPoolServer
