...
CC = g++
CFLAGS = -g -c -ggdb -Wall -DBUILD_TIME="\"`date`\"" -DDEBUG -Wno-deprecated-declarations
LIB = -lcurl -ljsoncpp -llog4cplus -lgumbo -lpthread -lzmq ./../lib/libCommonServer.so
